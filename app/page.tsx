...
export default function Home() {
  ...
  <main className="">
    ...
    {/* about stop */}
        ...
        {/* porto start */}
        <section id="portfolio" className="pt-36 pb-16 bg-soft mx-auto w-full flex items-center justify-center">
          <div className="container">
            <div className="w-full px-4">
              <div className="max-w-xl mx-auto text-center mb-16 gadget:m-40">
